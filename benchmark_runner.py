...
with open("test/cprofile_rust_cython_cubao.py", "rb") as f4:
    c4 = f4.read()
...
cProfile.run(c4, "test/output_stats_rust_cython_cubao")
cubao = pstats.Stats("test/output_stats_rust_cython_cubao")
...
cubao.sort_stats("cumulative").print_stats(20)
